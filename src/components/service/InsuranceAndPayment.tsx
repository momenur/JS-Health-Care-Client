        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            <Typography variant="body1" sx={{ color: "#4b5563", mb: 3 }}>
              We offer various payment options to make healthcare accessible and
              convenient for all our patients:
            </Typography>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            <Typography variant="body1" sx={{ color: "#4b5563", mb: 4 }}>
              We work with most major insurance providers to ensure you receive
              the care you need. Some of our accepted insurance plans include:
            </Typography>
